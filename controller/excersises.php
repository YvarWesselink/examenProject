...
class excersises extends Database {
    ...
    public static function showFields() {
        ...
        while ($count > $i) {
            ...
            echo "<label>".$tables[$i]['Field']."</label>"."<br>"."<input type='$type' name='".$tables[$i]['Field']."'><br>";
            $i ++;
        }

        echo '<h2 class="h2Style">2 Contact/bedrijf gegevens</h2>';
        ...
        while ($countt > $x) {
            ...
            echo "<label>".$tabless[$x]['Field']."</label>"."<br>"."<input type='$typee' name='".$tabless[$x]['Field']."'><br>";
            $x ++;
        }
    }

    public static function UploadExersise() {
        $conn = self::connect();
